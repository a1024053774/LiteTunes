...
class CruelSummerActivity : AppCompatActivity() {
    //播放按钮
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.music_activity_cruel_summer)
        imageView = findViewById(R.id.image_cruel_summer)
    ...
    fun play() {
        try {
            if (mMediaPlayer == null || state == STOP) {
                ...
                mMediaPlayer = MediaPlayer.create(this, R.raw.cruel_summer)
