...
class GuaikaActivity : AppCompatActivity() {
    //播放按钮
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.music_activity_guaika)
        imageView = findViewById(R.id.image_guaika)
        // 初始化播放按钮
    ...
    fun play() {
        try {
            if (mMediaPlayer == null || state == STOP) {
                ...
                mMediaPlayer = MediaPlayer.create(this, R.raw.guaika)
