...
class JiangbuchuzaijianActivity : AppCompatActivity() {
    //播放按钮
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.music_activity_jiangbuchuzaijian)
        imageView = findViewById(R.id.image_jiangbuchuzaijian)
        // 初始化播放按钮
    ...
    fun play() {
        try {
            if (mMediaPlayer == null || state == STOP) {
                ...
                mMediaPlayer = MediaPlayer.create(this, R.raw.jiangbuchuzaijian)
